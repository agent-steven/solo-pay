...
**해결 방법**: 에스크로 기한이 지나면 API로는 확정(finalize)할 수 없습니다. permissionless cancel이 활성화되어 누구나 온체인에서 cancel을 호출할 수 있으며, 호출 시 자금이 구매자에게 환불됩니다.
...
FINALIZED 상태가 아닌 결제에 대해 환불을 요청할 때 반환됩니다.
