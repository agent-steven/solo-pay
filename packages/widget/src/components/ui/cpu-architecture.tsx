  ...
  return (
    ...
    >
      ...
      <g>
        ...
        />
        {/* CPU Text / Symbol Image SVG Replacement */}
        <svg
          x="94"
          y="40"
          width="12"
          height="20"
          viewBox="0 0 43.94 57.51"
          fill={animateText ? 'url(#cpu-text-gradient)' : 'white'}
        >
          <path d="M24.72,25.16h0S43.94,0,43.94,0h-21.97L0,28.75h18.08c3.81,0,1.31,3.37,1.14,3.6h0S0,57.51,0,57.51h21.97l21.97-28.75h-18.08c-3.81,0-1.31-3.37-1.14-3.6Z" />
        </svg>
      </g>
      {/* Masks */}
      <defs>
